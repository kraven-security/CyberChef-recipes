...
This repository contains a list of CyberChef recipes you may find useful when working with data in cyber security. The repo is split into recipe types, each described below. All recipes in Chef format so they are easy to read and copy/paste to the platform. Good luck with your data manipulations!
